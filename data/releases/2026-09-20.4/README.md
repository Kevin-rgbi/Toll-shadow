# Toll Shadow Data Release 2026-09-20.4

Generated with transform version `pipeline-release-1.4.0`.

## Assets

- `traffic_observations`: `/data/releases/2026-09-20.4/traffic_observations.geojson` (2082788 bytes, SHA-256 `c3baeeaff9799c77e5e26448a8d3723ac90b81106b1302fb2c03d6015fc92ab7`)
- `facility_crossings`: `/data/releases/2026-09-20.4/facility_crossings.json` (3596098 bytes, SHA-256 `b39cb694bd8f98f0ef3a2dfb844dd55fdf1a18b83794b4b0a20c2fa39f4452a8`)
- `crz_context`: `/data/releases/2026-09-20.4/crz_entry_summary.json` (85191 bytes, SHA-256 `2b0f37d2a57975ea3068668f7a7212efdd6a2d982cead979215f685d04da1372`)
- `historical_context`: `/data/releases/2026-09-20.4/air_context.json` (34186 bytes, SHA-256 `51bd201f71dcad62a878a49c61432a6faffcac6f1a705f823c95d145813b8b97`)
- `health_context`: `/data/releases/2026-09-20.4/health_context.json` (28287 bytes, SHA-256 `770554d942def23710a4de899f220ff221d5ff969a47a8013d815933bb022097`)
- `dac_context`: `/data/releases/2026-09-20.4/equity_context.geojson` (481251 bytes, SHA-256 `e27c3f063511107c0b0a0ada77a7e31a1d0b98f97c7b066cd00157faadeba16e`)
